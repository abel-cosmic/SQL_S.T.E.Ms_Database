...
UPDATE Lab_Lecture_Course SET Lecture_Hour  = Contact_Hour FROM COURSE --TO ENFORCE LECTURE HOUR TO NOT BE GREATER THAN THE CONTACT HOUR ASSIGNED IN THE DEPARTMENT TABLE
